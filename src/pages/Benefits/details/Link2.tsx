    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Take the monotony out of composites Pattern Design and Grading, leverage custom made tools and libraries and automate the workflow eliminating human errors.
          </p>
