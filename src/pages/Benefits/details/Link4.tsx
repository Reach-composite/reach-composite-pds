    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Manage various projects easily by having all details of digital patterns of different orders for composites easily available for ready reference at any time.
          </p>
